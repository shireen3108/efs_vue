  ...
  <v-main>
    ...
    <v-container fluid>
      <v-row align="center" justify="center">
                   <span class="headline">Investments </span>
    ...
    methods: {
      ...
      getInvestments() {
        ...
        apiService.getInvestmentList().then(response => {
          ...
          this.investments = response.data.data.filter(a=>   
          {
             if (this.admins.includes(localStorage.getItem("log_user").replaceAll("\"","")))
             return true; 
      ...
      deleteInvestment(investment) {
        this.$confirm(`Are you sure, you want to delete the investment '${investment.description} - ${investment.acquired_value}'`).then(() => {
